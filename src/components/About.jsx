    ...
    >
      ...
      <div className="text-center md:text-left max-w-4xl">
        ...
        <p className="text-lg sm:text-2xl md:text-3xl leading-relaxed">
          ...
          passionate about turning ideas into reality. I create
          responsive, visually stunning websites/apps that help businesses
          shine and thrive in the digital world with unique, user-centered
          designs. Also worked on some projects with AI and ML.
        </p>
      </div>
    </div>
  );
