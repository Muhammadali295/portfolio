...
const experiences = [
  {
    ...
    date: "Nov & Dec - 2024",
    description:
      "make different production level apps using react-native",
  },
  {
    company: "ODOLUTION",
    role: "Odoo Developer Internship",
    date: "May - 2024",
    description: "making models, modifying xml files, programming in python etc",
  },
  {
    company: "NCL",
    role: "Data Analyst Internship",
    date: "March & April - 2023",
    description: "Clean, Analyze and vectorize (EDA) of ECG data (Realtime Agha-khan patients)",
  },
  {
    company: "NCBC",
    role: "MERN STACK DEV. Internship ",
    date: "March & April 2024",
    description: "Designing, developing responsive HEC website and managing DATABASES",
  },
];
